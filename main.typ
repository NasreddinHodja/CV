...
- Development of a digital healthcare platform connecting hospitals and doctors, including both web and mobile applications. Architected and delivered core features using TypeScript, Nuxt, and Supabase, later migrating both apps to Flutter for cross-platform maintainability.
  - Architected and implemented a real-time chat system (front-end and back-end) used daily by over N doctors.
...
#work(
  ...
  location: "Rio de Janeiro, RJ",
  company: "Themia-SAS",
  dates: dates-helper(start-date: "Mar 2025"),
)
...
- *Algorithm and Programming Competitions - UFRJ Extension Project*:
  - Taught in 2 instances of the Python course for elementary school students from public schools
  - Participation in the National Week of Science and Technology (SNCT)
  - Participation in the 2017 Programming Marathon
  - Taught in the preparatory course for OBI (Brazilian Informatics Olympiad) for high school students (OBI Week at UFRJ)

== Skills

- **Languages**: TypeScript, JavaScript, Python, C/C++, Dart, Rust  
